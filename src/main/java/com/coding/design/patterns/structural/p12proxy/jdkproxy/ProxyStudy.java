...
public class ProxyStudy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 代理产生的对象
        Collection<String> proxyBuildCollection = (Collection<String>) constructor
                .newInstance(new InvocationHandler() {
                    ...
                    final ArrayList<String> target = new ArrayList<>();// 动态类的目标对象
        ...
        Collection<String> proxyBuildCollection2 = (Collection<String>) Proxy.newProxyInstance(
        ...
        Set<String> proxySet = (Set<String>) buildProxy(new HashSet<String>(), new MyAdvice());
        proxySet.add("abc");
        proxySet.size();
    }
